...
<div id="drawer-navigation" class="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
    <a href="/" class="flex items-center ps-2.5 mb-5">
       <img src="images/sunny.png" class="h-6 me-3 sm:h-7" alt="Flowbite Logo" />
       <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Weather Capp</span>
    </a>
      ...
      <ul class="space-y-2 font-medium">
         ...
         @auth
            ...
            <li data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Add location</span>
                </a>
            </li>
         @endauth
